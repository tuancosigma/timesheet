...
final class QuickEntryWeekType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $projectOptions = [
            ...
            // Keep bootstrap-select dropdown within the themed quick-entry card,
            // so dark-mode styles are not lost when menu is attached elsewhere.
            'attr' => [
                'data-container' => '#quick_entry_box',
