...
class WorkingTime
{
    ...
    /**
     * Mark this day as "on-site" for the incentive report.
     *
     * Note: the database column name is `onesite` for historical reasons / naming convention.
     */
    #[ORM\Column(name: 'onesite', type: Types::BOOLEAN, nullable: false, options: ['default' => false])]
    ...
    public function setOnsite(bool $onsite): void
    {
        $this->onsite = $onsite;
    }
}
