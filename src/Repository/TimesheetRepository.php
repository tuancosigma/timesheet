...
class TimesheetRepository extends EntityRepository
{
    ...
    public function prepareTimesheetQuery(Query $query, ?TimesheetQuery $timesheetQuery = null): Query
    {
        ...
        $query->setFetchMode(Timesheet::class, 'meta', ClassMetadataInfo::FETCH_EAGER);
        $query->setFetchMode(Timesheet::class, 'activity', ClassMetadataInfo::FETCH_EAGER);
        $query->setFetchMode(Timesheet::class, 'project', ClassMetadataInfo::FETCH_EAGER);
        $query->setFetchMode(Timesheet::class, 'user', ClassMetadataInfo::FETCH_EAGER);
